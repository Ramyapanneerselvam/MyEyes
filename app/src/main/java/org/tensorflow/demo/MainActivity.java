...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.object_detect).setOnClickListener(this);
...
*/
    ...
    public void onClick(View v) {
        ...
        else if (v.getId() ==R.id.object_detect) {
    ...
    private void showTut() {
        ...
        mClingManager.addCling(new Cling.Builder(this)
                ...
                .setTarget(new com.majeur.cling.ViewTarget(this, R.id.object_detect))
                .build());
        content="Just DRAG two fingers simultaneously to start object detection";
        mClingManager.addCling(new Cling.Builder(this)
                .setTitle("Alternatively")
                .setContent(content)
                .build());
